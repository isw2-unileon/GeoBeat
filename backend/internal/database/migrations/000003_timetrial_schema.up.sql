CREATE TABLE timetrial_challenges (
...
CREATE TABLE timetrial_sessions (
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    challenge_id INT NOT NULL REFERENCES timetrial_challenges(id) ON DELETE CASCADE,
...
CREATE INDEX idx_timetrial_leaderboard 
ON timetrial_sessions (challenge_id, duration ASC) 
